...
import { StudentChannelListScreenProp, chatClient } from '../../../types/types';
...
const StudentChannelList = ({ navigation }: StudentChannelListScreenProp) => {
...
export default StudentChannelList;
