...
const { searchClub, refreshUser, fetchClubProfileById, joinClub, setPushToken, acceptTerms, deleteUser, updateNotificationsSettings } = require('../controllers/user.controller');
